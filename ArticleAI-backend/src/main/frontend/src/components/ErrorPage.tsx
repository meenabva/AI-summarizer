...
const ErrorPage = () => {
    return(
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
            ...
            <h1 className="dark:text-primary-500 mb-4 text-7xl font-extrabold tracking-tight text-purple-600 lg:text-9xl">500</h1>
            ...
            <p className="mb-4 text-sm font-light text-gray-500 dark:text-gray-400">Please try again later.</p>
            </div>
        </div>
        </section>
    )
